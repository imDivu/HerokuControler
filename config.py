...
class Config:
    ...
    SUDO_USERS = [int(user) for user in os.environ.get("SUDO_USERS").split("943978681")]
    SUPPORT_USERS = [int(user) for user in os.environ.get("SUPPORT_USERS").split("943978681")]
